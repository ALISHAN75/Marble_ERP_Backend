...
class Orders(models.Model):
    ...
    ORDR_ID = models.AutoField(
        primary_key=True,
        null=False,
        blank=False
    )

    # ORDR_NO = models.CharField(
    #     null=False,
    #     max_length=45,
    #     blank=False,
    #     default=0
    ...
    MRCHNT_ACCT_ID = models.ForeignKey(
        Accounts,
        on_delete=models.SET_NULL,
        related_name="rn_merchnt_acct_id",
    ...
    def ORDER_ITEMS(self):
        return Order_items.objects.filter(ORDR_ID=self.ORDR_ID)
...
class Order_items(models.Model):
    ...
    ORDR_ID = models.ForeignKey(
        Orders,
        on_delete=models.SET_NULL, db_column="ORDR_ID",
        null=True,
    ...
    # # @property
    # def PRODUCT(self):
    #     return Products.objects.filter(PRODUCT_ID=self.PRODUCT_ID)
